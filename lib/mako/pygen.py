...
class PythonPrinter(object):
    ...
    def writeline(self, line):
        ...
        if re.search(r":[ \t]*(?:#.*)?$", line):
            ...
            match = re.match(r"^\s*(if|try|elif|while|for|with|except|else)", line)   #################  Edited by Christopher Sebastian:  Added "|except|else" for try-except-else-finally Control Line support.
            if match:
