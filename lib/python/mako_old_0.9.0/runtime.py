...
class Undefined(object):
    ...
    """
    def __init__(self, name):                        # By Christopher Sebastian
        self.name = name                             # By Christopher Sebastian

    def __str__(self):
        raise NameError("Undefined: %s"%(self.name,)) # Edited by Christopher Sebastian
    ...
    def __eq__(self, other):                          # By Christopher Sebastian
        return self.__class__ == other.__class__      # By Christopher Sebastian
